...
type C:\Utilities\BAKTools\logs\log.log
echo.
...
echo .... QUERY 1
echo.     
sqlcmd -U sa -P innovator -S %svr% -i C:\Utilities\BAKTools\queries\sp_change_users_login.sql -d %db% -o C:\Utilities\BAKTools\logs\users.log
type C:\Utilities\BAKTools\logs\users.log
echo.     
echo .... QUERY 2
echo.     
sqlcmd -U sa -P innovator -S %svr% -i C:\Utilities\BAKTools\queries\sp_grantdbaccess.sql -d %db% -o C:\Utilities\BAKTools\logs\access.log
type C:\Utilities\BAKTools\logs\access.log
echo.     
echo .... QUERY 3
echo.     
sqlcmd -U sa -P innovator -S %svr% -i C:\Utilities\BAKTools\queries\sp_addrolemember.sql -d %db% -o C:\Utilities\BAKTools\logs\role.log
type C:\Utilities\BAKTools\logs\role.log
echo.
echo ..............................................................
echo.       
...
@REM goto check_if_customer
	...
	@REM echo.     
	@REM sqlcmd -U sa -P innovator -S %svr% -i C:\Utilities\BAKTools\queries\customer_restore.sql -d %db% -o C:\Utilities\BAKTools\logs\customer.log
	@REM type C:\Utilities\BAKTools\logs\customer.log
	@REM echo.
